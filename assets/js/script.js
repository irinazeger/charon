...
// конец бургера
// начало код срабатывания бургер меню на чистом javascript
var burgerTabletCtr = document.querySelector("#burger-menu-tablet");
var menuTabletCtr = document.querySelector("#tablet-menu");
burgerTabletCtr.addEventListener("click", function () {
  this.classList.toggle("active");
  menuTabletCtr.classList.toggle("show_tablet_menu");
});
// конец бургера
